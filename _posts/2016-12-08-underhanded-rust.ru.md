...
* Можете использовать контейнеры из [crates.io](https://crates.io) 
  (включая ваши собственные), если они не увеличивают размер вашего 
...
* `blogpost/` - Директория, содержащая объйснение в виде "блог поста".
...
* Одна плющевая игрушка ограничнного издания Ferris и стикеры победителю(-ям).
...
Призы, если будут, может такое произойти, не будет возможности доставить 
победителю, например, он живет в стране, в отношении которой действует эмбарго или 
другие юридические причины. В случае, если призы не могут быть вручены в связи с 
юридическими ограничениями, организаторы конкурса приложат все усилия, 
чтобы разрешить ситуацию в рамках действующего законодательстваs; если выясняется, 
что ситуация не разрешима, призы будут переданы на благотворительность.
...
Rust призы (swag, и т.д.) будут выданы второму месту.
